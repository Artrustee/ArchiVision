...
{
    public class PointRenderItem : GeometryDisplayItem
    {
        public PointStyle PtStyle { get; protected set; }
        public float Radius { get; protected set; }
        public PointRenderItem(IGH_DocumentObject owner, GH_Point point, Color color, PointStyle style, float radius, bool topMost)
