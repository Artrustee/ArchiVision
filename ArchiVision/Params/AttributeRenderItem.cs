...
{
    public abstract class AttributeRenderItem : BaseRenderItem
    {
        ...
        public AttributeRenderItem(IGH_PreviewData geometry, Color color = default(Color), bool topMost = false)
            :base(topMost)
        {
            Geometry = geometry;
            Colour = color;
