...
namespace ArchiVision
{
    public class MeshDisplayItem : GeometryDisplayItem
    {
        ...
        public MeshDisplayItem(IGH_DocumentObject owner, GH_Mesh geometry, GH_Material material, CurveDisplayAttribute nakedEdgeAtt, CurveDisplayAttribute interiorEdgeAtt, CurveDisplayAttribute outLineAtt, CurveDisplayAttribute sharpEdgeAtt, double angle)
